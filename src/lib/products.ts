...
export const products: Product[] = [
  {
    ...
    icon: 'article',
    descriptionJa:
      '競合調査、テーマ選定、構成、記事執筆、公開準備までを1本からまとめて依頼できる記事制作サービス。',
    descriptionEn:
      'A one-off content production service covering competitor research, topic selection, structure, writing, and publication preparation.',
  },
  {
    ...
    icon: 'followup',
    descriptionJa:
      'LINE登録後7日間のシナリオ設計、配信原稿7通、配信設定とテストまでをまとめて初期構築するサービス。',
    descriptionEn:
      'A setup service for a seven-day LINE follow-up flow, including scenario design, seven messages, configuration, and testing.',
  },
  {
    ...
    descriptionEn:
      'AI automation services for recurring work such as PDF search, spreadsheet entry, and email processing.',
  },
  {
    title: 'LINE Setup',
  ...
  },
  {
    ...
    descriptionEn:
      'A research-driven media site about ingredients and anti-aging care from your thirties onward.',
  },
  {
